...
fun Material3(
    ...
    Scaffold(
        ...
        VerticalScrollColumn(
            ...
            CardsDemo()
            NavigationBarDemo()
            DropdownMenusAndSelectsDemo()
            ProgressIndicatorsDemo()
            RadioButtonsDemo()
            HorizontalDivider()
            SlidersDemo()
            BadgesDemo()
            ChipsDemo(scope, snackbarHostState)
            DialogsDemo()
            TabsDemo()
...
@Composable
private fun ButtonsDemo(count: Int, onClick: () -> Unit) {
...
@Composable
private fun IconToggleButtonsDemo(checked: Boolean, onCheckedChange: (Boolean) -> Unit) {
...
@Composable
private fun CheckboxAndSwitchDemo(checked: Boolean, onCheckedChange: (Boolean) -> Unit) {
    Row {
...
@Composable
private fun TextFieldsDemo(scope: CoroutineScope, snackbarHostState: SnackbarHostState) {
...
@Composable
private fun ListDemo(count: Int) {
...
@Composable
private fun DropdownMenusAndSelectsDemo() {
    @Composable
...
@Composable
private fun ChipsDemo(scope: CoroutineScope, snackbarHostState: SnackbarHostState) {
...
@Composable
private fun SegmentedButtonsDemo() {
...
@Composable
private fun TopAppBarsDemo(scope: CoroutineScope, snackbarHostState: SnackbarHostState) {
    Text("Top App Bars:")
    TopAppBar(
        title = { Text("Small") },
        navigationIcon = {
...
@Composable
private fun SnackbarDemo(scope: CoroutineScope, snackbarHostState: SnackbarHostState) {
...
@Composable
private fun NavigationDrawerDemo(scope: CoroutineScope) {
